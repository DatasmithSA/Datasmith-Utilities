...
namespace NMG.Core.Generator
{
    public class ByCodeGenerator : AbstractCodeGenerator
    {
        ...
        public override void Generate(bool writeToFile = true)
        {
            ...
            var unformattedTextFormatter = new UnformattedTextFormatter() { PrefixRemovalList = appPrefs.FieldPrefixRemovalList };

            var className = string.Format("{0}{1}{2}", appPrefs.ClassNamePrefix, unformattedTextFormatter.FormatSingular(Table.Name), "Map");
